train_folderPath = <training folder> %'C:\Users\Nabanita\Desktop\train\';
test_folderPath = <testing folder> %'C:\Users\Nabanita\Desktop\Testing\*.jpg';
test_folder = <testing folder>  %'C:\Users\Nabanita\Desktop\Testing\';
D = dir([<training folder>]);%'C:\Users\Nabanita\Desktop\train\*'
num_classes=0;
classes=[];
str2 ='.';
for i=1:length(D)
